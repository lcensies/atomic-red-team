...
- [Atomic Test #20 - Accept incoming traffic to specified port via iptables](#atomic-test-20---accept-incoming-traffic-to-specified-port-via-iptables)

- [Atomic Test #21 - LockBit Black - Unusual Windows firewall registry modification -cmd](#atomic-test-21---lockbit-black---unusual-windows-firewall-registry-modification--cmd)

- [Atomic Test #22 - LockBit Black - Unusual Windows firewall registry modification -Powershell](#atomic-test-22---lockbit-black---unusual-windows-firewall-registry-modification--powershell)

- [Atomic Test #23 - Blackbit - Disable Windows Firewall using netsh firewall](#atomic-test-23---blackbit---disable-windows-firewall-using-netsh-firewall)
...
## Atomic Test #20 - Accept incoming traffic to specified port via iptables
Emulates backdoor's firewall bypass via iptables rules modification

**Supported Platforms:** Linux


**auto_generated_guid:** 834cfe86-3640-4b60-8578-34d581307cb4
...
## Atomic Test #21 - LockBit Black - Unusual Windows firewall registry modification -cmd
...
## Atomic Test #22 - LockBit Black - Unusual Windows firewall registry modification -Powershell
An adversary tries to modify the windows firewall registry.
...
## Atomic Test #23 - Blackbit - Disable Windows Firewall using netsh firewall

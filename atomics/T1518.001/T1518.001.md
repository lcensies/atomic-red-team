...
- [Atomic Test #11 - Security Software Discovery - Access SELinux Configuration Files](#atomic-test-11---security-software-discovery---access-selinux-configuration-files)

- [Atomic Test #12 - Security Software Discovery - Get SELinux status via getenforce](#atomic-test-12---security-software-discovery---get-selinux-status-via-getenforce)

- [Atomic Test #13 - Security Software Discovery - ClamAV service](#atomic-test-13---security-software-discovery---clamav-service)
...
## Atomic Test #11 - Security Software Discovery - Access SELinux Configuration Files
Attempts to read the SELinux configuration files to simulate an adversary's behavior trying to discover or alter SELinux policies.

**Supported Platforms:** Linux


**auto_generated_guid:** 76756836-b5a8-4c6c-8926-8bccb06db3b0
...
## Atomic Test #12 - Security Software Discovery - Get SELinux status via getenforce
Attempts to read the SELinux configuration files to simulate an adversary's behavior trying to discover or alter SELinux policies.

**Supported Platforms:** Linux


**auto_generated_guid:** 3fce2ceb-6e66-474d-8f43-971973565cbb
...
## Atomic Test #13 - Security Software Discovery - ClamAV service
Attempts to check the status of ClamAV service to simulate an adversary's behavior trying to discover whether ClamAV is installed on target host.

**Supported Platforms:** Linux


**auto_generated_guid:** ebd49569-67cd-4499-8418-8d83587f6857

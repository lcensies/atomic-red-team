...
| art_db_path | Path to the sqlite3 art database | string | PathToAtomicsFolder/T1005/src/art|
| gta_db_path | Path to the sqlite3 gta database | string | PathToAtomicsFolder/T1005/src/gta.db|
| sqlite_dump_script_path | Path to the sqlite_dump.sh script | string | PathToAtomicsFolder/T1005/src/sqlite_dump.sh|
...
```bash
cd $(dirname  #{sqlite_dump_script_path})
chmod +x  #{sqlite_dump_script_path}

...
- [Atomic Test #5 - Execute Command via Cron Job with find and -exec](#atomic-test-5---execute-command-via-cron-job-with-find-and--exec)
...
## Atomic Test #5 - Execute Command via Cron Job with find and -exec
...
##### Description: Requires cron or a similar scheduler to be present and running on the system.
